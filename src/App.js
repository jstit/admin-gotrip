    ...
    <div>
      <div className="navbar">
        ...
        <ul className="navbar-nav">
          ...
          <li className="nav-item">
            <img src="assets/AT-pro-black.png" alt="ATPro logo" className="logo logo-light" />
            <img src="assets/AT-pro-white.png" alt="ATPro logo" className="logo logo-dark" />
          </li>
        </ul>
        {/* end nav left */}
        {/* form */}
        ...
        <ul className="navbar-nav nav-right">
          ...
          <li className="nav-item avt-wrapper">
            <div className="avt dropdown">
              <img src="assets/tuat.jpg" alt="User image" className="dropdown-toggle" data-toggle="user-menu" />
